            ...
            <section class="cta section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="cta-text">
                                <h2>Descubra o local ideal para você</h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo PATH ?>assets/js/lib/slick/slick.js"></script>
    <script src="<?php echo PATH ?>assets/js/scripts.js"></script>
